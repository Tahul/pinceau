...
export const PINCEAU_JS_EXTENSIONS = ['js', 'jsx', 'mjs', 'ts', 'tsx', 'jsx', 'tsx', 'js', 'ts']
export const PINCEAU_SUPPORTED_EXTENSIONS = [...PINCEAU_STYLES_EXTENSIONS, ...PINCEAU_JS_EXTENSIONS, 'vue']
