...
import type { ColorSchemeModes, PinceauMediaQueries } from '@pinceau/shared'
import { astTypes, flattenTokens, isSafeConstName, message, objectPaths, printAst, resolveThemeRule, walkTokens } from '@pinceau/shared'
import type { TSLiteralTypeKind } from 'ast-types/lib/gen/kinds'
...
function enhanceTokenPaths(value = []) {
  const tokensLiteralNodes: TSLiteralTypeKind[] = []
