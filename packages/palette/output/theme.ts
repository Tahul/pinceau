...
export type PinceauMediaQueries = "$dark" | "$light" | "$initial" | "$xs" | "$sm" | "$md" | "$lg" | "$xl" | "$xxl" | "$rm" | "$landscape" | "$portrait";

export type PinceauThemePaths = "$media.xs" | "$media.sm" | "$media.md" | "$media.lg" | "$media.xl" | "$media.xxl" | "$media.rm" | "$media.landscape" | "$media.portrait" | "$color.white" | "$color.black" | "$color.primary.0" | "$color.primary.1" | "$color.primary.2" | "$color.primary.3" | "$color.primary.4" | "$color.primary.5" | "$color.primary.6" | "$color.primary.7" | "$color.primary.8" | "$color.primary.9" | "$color.pink.0" | "$color.pink.1" | "$color.pink.2" | "$color.pink.3" | "$color.pink.4" | "$color.pink.5" | "$color.pink.6" | "$color.pink.7" | "$color.pink.8" | "$color.pink.9" | "$color.purple.0" | "$color.purple.1" | "$color.purple.2" | "$color.purple.3" | "$color.purple.4" | "$color.purple.5" | "$color.purple.6" | "$color.purple.7" | "$color.purple.8" | "$color.purple.9" | "$color.blue.0" | "$color.blue.1" | "$color.blue.2" | "$color.blue.3" | "$color.blue.4" | "$color.blue.5" | "$color.blue.6" | "$color.blue.7" | "$color.blue.8" | "$color.blue.9" | "$color.lightblue.0" | "$color.lightblue.1" | "$color.lightblue.2" | "$color.lightblue.3" | "$color.lightblue.4" | "$color.lightblue.5" | "$color.lightblue.6" | "$color.lightblue.7" | "$color.lightblue.8" | "$color.lightblue.9" | "$color.seagreen.0" | "$color.seagreen.1" | "$color.seagreen.2" | "$color.seagreen.3" | "$color.seagreen.4" | "$color.seagreen.5" | "$color.seagreen.6" | "$color.seagreen.7" | "$color.seagreen.8" | "$color.seagreen.9" | "$color.green.0" | "$color.green.1" | "$color.green.2" | "$color.green.3" | "$color.green.4" | "$color.green.5" | "$color.green.6" | "$color.green.7" | "$color.green.8" | "$color.green.9" | "$color.gray.0" | "$color.gray.1" | "$color.gray.2" | "$color.gray.3" | "$color.gray.4" | "$color.gray.5" | "$color.gray.6" | "$color.gray.7" | "$color.gray.8" | "$color.gray.9" | "$color.lime.0" | "$color.lime.1" | "$color.lime.2" | "$color.lime.3" | "$color.lime.4" | "$color.lime.5" | "$color.lime.6" | "$color.lime.7" | "$color.lime.8" | "$color.lime.9" | "$color.yellow.0" | "$color.yellow.1" | "$color.yellow.2" | "$color.yellow.3" | "$color.yellow.4" | "$color.yellow.5" | "$color.yellow.6" | "$color.yellow.7" | "$color.yellow.8" | "$color.yellow.9" | "$color.orange.0" | "$color.orange.1" | "$color.orange.2" | "$color.orange.3" | "$color.orange.4" | "$color.orange.5" | "$color.orange.6" | "$color.orange.7" | "$color.orange.8" | "$color.orange.9" | "$color.red.0" | "$color.red.1" | "$color.red.2" | "$color.red.3" | "$color.red.4" | "$color.red.5" | "$color.red.6" | "$color.red.7" | "$color.red.8" | "$color.red.9" | "$color.magenta.0" | "$color.magenta.1" | "$color.magenta.2" | "$color.magenta.3" | "$color.magenta.4" | "$color.magenta.5" | "$color.magenta.6" | "$color.magenta.7" | "$color.magenta.8" | "$color.magenta.9" | "$shadow.xs" | "$shadow.sm" | "$shadow.md" | "$shadow.lg" | "$shadow.xl" | "$shadow.2xl" | "$shadow.none" | "$radii.none" | "$radii.3xs" | "$radii.2xs" | "$radii.xs" | "$radii.sm" | "$radii.md" | "$radii.lg" | "$radii.xl" | "$radii.2xl" | "$radii.3xl" | "$radii.4xl" | "$radii.5xl" | "$radii.6xl" | "$radii.full" | "$size.0" | "$size.2" | "$size.4" | "$size.6" | "$size.8" | "$size.12" | "$size.16" | "$size.20" | "$size.24" | "$size.32" | "$size.40" | "$size.48" | "$size.56" | "$size.64" | "$size.80" | "$size.104" | "$size.200" | "$size.xs" | "$size.sm" | "$size.md" | "$size.lg" | "$size.xl" | "$size.2xl" | "$size.3xl" | "$size.4xl" | "$size.5xl" | "$size.6xl" | "$size.7xl" | "$size.full" | "$space.0" | "$space.1" | "$space.2" | "$space.3" | "$space.4" | "$space.5" | "$space.6" | "$space.7" | "$space.8" | "$space.9" | "$space.10" | "$space.11" | "$space.12" | "$space.14" | "$space.16" | "$space.20" | "$space.24" | "$space.28" | "$space.32" | "$space.36" | "$space.40" | "$space.44" | "$space.48" | "$space.52" | "$space.56" | "$space.60" | "$space.64" | "$space.72" | "$space.80" | "$space.96" | "$borderWidth.noBorder" | "$borderWidth.sm" | "$borderWidth.md" | "$borderWidth.lg" | "$opacity.noOpacity" | "$opacity.bright" | "$opacity.light" | "$opacity.soft" | "$opacity.medium" | "$opacity.high" | "$opacity.total" | "$font.sans" | "$font.serif" | "$font.mono" | "$fontWeight.thin" | "$fontWeight.extralight" | "$fontWeight.light" | "$fontWeight.normal" | "$fontWeight.medium" | "$fontWeight.semibold" | "$fontWeight.bold" | "$fontWeight.extrabold" | "$fontWeight.black" | "$fontSize.xs" | "$fontSize.sm" | "$fontSize.base" | "$fontSize.lg" | "$fontSize.xl" | "$fontSize.2xl" | "$fontSize.3xl" | "$fontSize.4xl" | "$fontSize.5xl" | "$fontSize.6xl" | "$fontSize.7xl" | "$fontSize.8xl" | "$fontSize.9xl" | "$letterSpacing.tighter" | "$letterSpacing.tight" | "$letterSpacing.normal" | "$letterSpacing.wide" | "$letterSpacing.wider" | "$letterSpacing.widest" | "$lead.1" | "$lead.2" | "$lead.3" | "$lead.4" | "$lead.5" | "$lead.6" | "$lead.7" | "$lead.8" | "$lead.9" | "$lead.10" | "$lead.none" | "$lead.tight" | "$lead.snug" | "$lead.normal" | "$lead.relaxed" | "$lead.loose" | "$text.1.fontSize" | "$text.1.lineHeight" | "$text.2.fontSize" | "$text.2.lineHeight" | "$text.3.fontSize" | "$text.3.lineHeight" | "$text.4.fontSize" | "$text.4.lineHeight" | "$text.5.fontSize" | "$text.5.lineHeight" | "$text.6.fontSize" | "$text.6.lineHeight" | "$text.7.fontSize" | "$text.7.lineHeight" | "$text.8.fontSize" | "$text.8.lineHeight" | "$text.9.fontSize" | "$text.9.lineHeight" | "$text.10.fontSize" | "$text.10.lineHeight" | "$ease.linear" | "$ease.default.in" | "$ease.default.out" | "$ease.default.inOut" | "$ease.sine.in" | "$ease.sine.out" | "$ease.sine.inOut" | "$ease.quad.in" | "$ease.quad.out" | "$ease.quad.inOut" | "$ease.cubic.in" | "$ease.cubic.out" | "$ease.cubic.inOut" | "$ease.quart.in" | "$ease.quart.out" | "$ease.quart.inOut" | "$ease.quint.in" | "$ease.quint.out" | "$ease.quint.inOut" | "$ease.expo.in" | "$ease.expo.out" | "$ease.expo.inOut" | "$ease.circ.in" | "$ease.circ.out" | "$ease.circ.inOut" | "$ease.back.in" | "$ease.back.out" | "$ease.back.inOut";
