 ...
 */
export type ThemeProperties<K extends string> = K extends keyof DefaultThemeMap ? Utils.FilterStartingWith<PinceauThemePaths, `$${DefaultThemeMap[K]}`> : never

/**
 * Take a key and gives a list of tokens under that key in configuration.
 */
export type ThemeTokens<K extends PinceauThemePaths | (string & {})> = Utils.FilterStartingWith<PinceauThemePaths, K>
