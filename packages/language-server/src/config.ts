import type { Connection, InitializeParams, InitializeResult, TextDocuments } from 'vscode-languageserver'
...
import { defaultSettings } from './manager'
...
export function setupExtension(
  ...
  connection.onInitialize((params: InitializeParams) => {
    ...
    connection.onInitialized(async () => {
      ...
      rootPath = validFolders?.[0] as string
